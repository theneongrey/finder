            ...
            tapResponse({
              ...
              error: (error) => {
                store.loggerService.log(
                  '[PollStore] Error while loading projects',
                  error,
                );
              },
            }),
        ...
        switchMap(() => {
          return store.projectService.getStandalonePolls().pipe(
            tapResponse({
              ...
              error: (error) => {
                store.loggerService.log(
                  '[PollStore] Error while loading standalone polls',
                  error,
                );
              },
            }),
          ...
          return store.projectService
            ...
            .pipe(
              ...
              tapResponse({
                ...
                error: (error) => {
                  store.loggerService.log(
                    '[PollStore] Error while adding a standalone poll',
                    error,
                  );
                },
              }),
        ...
        switchMap((id) => {
          return store.projectService.getProject(id).pipe(
            tapResponse({
              ...
              error: (error) => {
                store.loggerService.log(
                  '[PollStore] Error while loading project',
                  error,
                );
              },
            }),
        ...
        switchMap((id) => {
          return store.projectService.getPoll(id).pipe(
            tapResponse({
              ...
              error: (error) => {
                store.loggerService.log(
                  '[PollStore] Error while loading poll',
                  error,
                );
              },
            }),
        ...
        switchMap((projectId) => {
          return store.projectService.deleteProject(projectId).pipe(
            tapResponse({
              ...
              error: (error) => {
                store.loggerService.log(
                  '[PollStore] Error deleting project',
                  error,
                );
              },
            }),
            ...
            .pipe(
              ...
              tapResponse({
                next: ({ responsePoll, addedOptions }) => {
                  ...
                  store.router.navigate([`/polls/${poll.projectId}`]);
                },
                error: (error) => {
                  store.loggerService.log(
                    '[PollStore] Error while adding a poll',
                    error,
                  );
                },
              }),
          ...
          return store.projectService
            ...
            .pipe(
              ...
              tapResponse({
                ...
                error: (error) => {
                  store.loggerService.log(
                    '[PollStore] Error while editing a poll',
                    error,
                  );
                },
              }),
          ...
          return store.projectService
            ...
            .pipe(
              tapResponse({
                ...
                error: (error) => {
                  store.loggerService.log(
                    '[PollStore] Error while adding an option',
                    error,
                  );
                },
              }),
        ...
        switchMap((optionId) => {
          return store.projectService.deleteOption(optionId).pipe(
            tapResponse({
              ...
              error: (error) => {
                store.loggerService.log(
                  '[PollStore] Error deleting option',
                  error,
                );
              },
            }),
          ...
          return store.permissionService
            ...
            .pipe(
              tapResponse({
                ...
                error: (error) => {
                  store.loggerService.log(
                    '[PollStore] Error updating visibility type',
                    error,
                  );
                },
              }),
        ...
        switchMap((projectId) => {
          return store.permissionService.getContacts(projectId).pipe(
            tapResponse({
              ...
              error: (error) => {
                store.loggerService.log(
                  '[PollStore] Error loading contacts',
                  error,
                );
              },
            }),
          ...
          return store.permissionService
            ...
            .pipe(
              tapResponse({
                ...
                error: (error) => {
                  store.loggerService.log(
                    '[PollStore] Error removing permission',
                    error,
                  );
                },
              }),
            ...
            tapResponse({
              next: (info) => {
                if (info.isStandalone && info.pollId) {
                  ...
                  store.router.navigate(['/polls', info.projectId]);
                }
              },
              error: (error) => {
                store.loggerService.log(
                  '[PollStore] Error navigating to shared project',
                  error,
                );
              },
            }),
          ...
          return store.projectService
            ...
            .pipe(
              tapResponse({
                ...
                error: (error) => {
                  store.loggerService.log(
                    '[PollStore] Error while adding a comment',
                    error,
                  );
                },
              }),
