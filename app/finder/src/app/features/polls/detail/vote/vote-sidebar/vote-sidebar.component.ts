...
import { VoteAnswerSummaryComponent, AnswerSummaryItem } from './vote-answer-summary/vote-answer-summary.component';

@Component({
  selector: 'app-vote-sidebar',
  templateUrl: './vote-sidebar.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [TranslatePipe, PollTypeBadgeComponent, AvatarStackComponent, DsIconComponent, VoteAnswerSummaryComponent],
  ...
  readonly answerSummary = computed((): AnswerSummaryItem[] => {
    ...
    return options.map(o => {
      ...
      if (isRating && isPositive) {
        ...
        badgeBg = 'var(--star-bg)'; badgeFg = 'var(--star-fg)'; dotBg = 'var(--star)';
      } else if (choiceNum === 1) {
